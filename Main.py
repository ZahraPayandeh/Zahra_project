...
def parse_arguments():
    ...
    parser.add_argument('--groupA', type=str, required=True, help='Images/groupA/')
    parser.add_argument('--groupB', type=str, required=True, help='Images/groupB/')
...
nucleus24_folder = args.groupA
nucleus38_folder = args.groupB
